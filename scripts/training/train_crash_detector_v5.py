"""
PHASE 3.5: Crash Detector V5 - Walk-Forward Validation (NO DATA LEAKAGE)
...
def train_crash_detector_v5():
    ...
    logger.info("\n✅ Models saved (v5)")
    logger.info(f"   - data/models/gb_model_v5.pkl")
    logger.info(f"   - data/models/rf_model_v5.pkl")
    logger.info(f"   - data/models/scaler_v5.pkl")
